              ...
              <div class="mobileView  justify-content-between p-0 ">
                  <div class="connector d-md-flex d-sm-grid col-md-8 col-12 align-content-center ">
                      <p class="emailIDD loveRate"><i class="lni lni-envelope lixonsZ" onclick="shareContent()"></i> <span
                              class="logEmail" onclick="shareContent()">reservation@ladakhthrill.com</span></p>
          ...
          <div class="col-md-3 col-sm-12 col-6 mt-3">
              <div class="card hotelView shadow ">
                  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="./assets/EcoLodge/IMG-20240306-WA0002.jpg" class="d-block w-100 " alt="..." >
                        </div>
                        <div class="carousel-item">
                          <img src="./assets/EcoLodge/IMG-20240306-WA0006.jpg" class="d-block w-100" alt="..." >
                        </div>
                        <div class="carousel-item">
                          <img src="./assets/EcoLodge/IMG-20240306-WA0003.jpg" class="d-block w-100" alt="..." >
                        </div>
                      </div>
                    </div>
                    <div class="card-body ">
          ...
          <div class="col-md-3 col-sm-12 col-6 mt-3">
              <div class="card hotelView shadow ">
                  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="./assets/thumbler/IMG-20240303-WA0007.jpg" class="d-block w-100" alt="...">
                        </div>
                       
                      </div>
                    </div>
                    <div class="card-body ">
                      <p class="card-title stayNamer mb-3">Sky Gazing, Stakmo.</p>
                     
                        
                      <a  class="  packgeData mt-1" onclick="showPackges('pack8')" style="cursor:pointer;">View more</a>
                    </div>
                </div>
          </div>
          <div class="col-md-3 col-sm-12 col-6 mt-3">
              <div class="card hotelView shadow ">
                  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="./assets/thumbler/ondatrek.jpg" class="d-block w-100" alt="...">
                        </div>
...
if (packagesData.pack6===packData) {
  document.querySelector('.pack1Trip').style.backgroundImage = 'url(./assets/SkyDrive/ondatrek.jpg)';
}
if (packagesData.pack7===packData) {
  document.querySelector('.pack1Trip').style.backgroundImage = 'url(./assets/SkyDrive/indusTrek.jpg)';
}
